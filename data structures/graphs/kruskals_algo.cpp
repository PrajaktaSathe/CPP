...
The cost of the spanning tree is the sum of the weights of all the edges in the tree.Of all the possible spanning trees 
the one with the minimum cost is said to be minimum cost spanning tree.
The main objective of using Kruskal’s algorithm is for getting the minimum cost spanning tree for a graph.
